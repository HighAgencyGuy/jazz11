...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        "gradient-hero": "linear-gradient(135deg, hsl(var(--cream)) 0%, hsl(var(--cream-dark)) 100%)",
        "gradient-wine": "linear-gradient(135deg, hsl(var(--wine)) 0%, hsl(var(--wine-dark)) 100%)",
