              ...
              <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} className="space-y-8">
                <div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-start gap-4"><Phone className="w-6 h-6 text-wine mt-1" /><div><p className="font-medium">Phone</p><a href="tel:+2348012345678" className="text-muted-foreground hover:text-wine">+234 801 234 5678</a></div></div>
                    <div className="flex items-start gap-4"><Mail className="w-6 h-6 text-wine mt-1" /><div><p className="font-medium">Email</p><a href="mailto:hello@jazz1111.com" className="text-muted-foreground hover:text-wine">hello@jazz1111.com</a></div></div>
                ...
                <a href="https://wa.me/2348012345678" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 px-6 py-3 bg-[#25D366] text-primary-foreground font-medium rounded-lg hover:bg-[#128C7E] transition-colors">
